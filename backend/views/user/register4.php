            ...
            <div id="mainContent">
                ...
                <div id="leftNavInternal" class="floatLeft">
                    <ul>
                        ...
                        <li class="last"><a href="#" onclick="helpOpen3('appreg/HelpServicesServlet?functionname=help&page=HELP.REGISTRATION.OSEASADDRESS.PAGE')">Help</a></li>
                    </ul><h3>Key</h3>
                    <ul id="key">
                            ...
                            <div class="thisForm">
                                ...
                                <div class="thisFormElem">
                                    ...
                                    <div class="thisFormField">
                                        ...
                                        <a href="#" onclick="helpOpen('HelpServicesServlet', '?functionname=help&amp;page=HELP.REGISTRATION.OSEASADDRESS.FIELD.ADDRESS'); return false;"><img src="/static/images/questMarkBox.gif" width="20" height="20" class="floatLeft" alt="Help"></a>
                                    </div>
                                ...
                                <div class="thisFormElem">
                                    ...
                                    <div class="thisFormField">
                                        ...
                                        <a href="#" onclick="helpOpen('HelpServicesServlet', '?functionname=help&amp;page=HELP.REGISTRATION.OSEASADDRESS.FIELD.COUNTRY'); return false;"><img src="/static/images/questMarkBox.gif" width="20" height="20" class="floatLeft" alt="Help"></a>
                                    </div>
                                </div><!--close form element -->
                                <br>
