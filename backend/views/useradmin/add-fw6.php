                ...
                <div id="midBoxInternalWide">
                    ...
                    <div class="thisForm">
                        ...
                        <form name="Form1" method="post" action="">
                            <input type="hidden" name="txtTitle" value="Cambridge International Project Qualification (Cambridge IPQ)">
                                ...
                                <?php foreach ($cboModYears as $key=>$cboModYear){?>
                                    <div id="unit" class="unit">
                                        ...
                                        <div class="thisFormElem"><!--open form element -->
                                            ...
                                            <div class="thisFormField">
                                                <input type="text" name="txtModGrade0[]" value="<?= \common\logics\Func::getAttributes($data, 'txtModGrade0')[$key]?>" size="14" maxlength="15" onchange="if(document.forms[0].modGradeCombo0){document.forms[0].modGradeCombo0.selectedIndex=0;}" class="floatLeft" id="modGradeTextEntry0">
                                                <a href="#" onclick="launchFieldHelp('PopUpServlet', '?functionname=help&amp;page=HELP.EDUCATION.QUALIFICATION.FIELD.MODGRADE'); return false;"><img src="/static/images/questMarkBox.gif" width="20" height="20" class="floatLeft" alt="Help"></a>
                                            </div>
                                        </div><!--close form element -->
                                        <div class="">
