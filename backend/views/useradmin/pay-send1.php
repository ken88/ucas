<?php include_once "top.php";?>
            ...
            <div id="strapLineApply">
                <h1 class="EN">Important reminders</h1>
            ...
            <div id="gatewayContent">
                ...
                <div id="midBoxInternalWide">
                    ...
                    <div class="thisForm">
                        ...
                        <form name="Form1" method="post" action="PaymentServlet?id=badd6313331d813e48fb8c7a44b8&amp;ran=hqbtmoxv1kty">


                            <strong>Important reminders</strong><br><br>

                            <strong>Please check the following carefully before you pay and send your application to us:</strong><br><br>
