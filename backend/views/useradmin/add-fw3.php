                ...
                <div id="midBoxInternalWide">
                    ...
                    <div class="thisForm">
                        ...
                        <form name="Form1" method="post" action="">
                            <h2 class="inPage">Oxford AQA International Advanced Subsidiary</h2>
                            ...
                            <div class="thisFormElem"><!--open form element -->
                                ...
                                <div class="thisFormField">
                                    <div id="fitWidth"><select name="cboTitle" size="1"  class="floatLeft" id="titleCombo">
                                            <option value="">Please select...</option>
                                            <?php
                                            $cboTitles = ['Biology','Chemistry','English Language','English Literature','Further Mathematics','Mathematics','Physics'];
                                            foreach ($cboTitles as $cboTitle){
                                            ?>
                                            <option <?php if ($cboTitle==\common\logics\Func::getAttributes($data,'cboTitle')) echo 'selected' ?> value="<?= $cboTitle ?>" ><?= $cboTitle?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                            ...
                            if (!($cboModYears && count($cboModYears)>0)){?>
                                <div id="unit" class="unit">
                                    ...
                                    <div class="thisFormElem"><!--open form element -->
                                        ...
                                        <div class="thisFormField">
                                            <div id="fitWidth" style="float: left; width: 90%">
                                                <select name="cboModTitle0[]" size="1" class="sub-x" id="modTitleCombo0">
                                                    <option value="">Please select...</option>
                                                </select>
                                            </div>
