            ...
            <div id="gatewayContent">
                ...
                <div id="midBoxInternalWide">
                    ...
                    <div class="thisForm">
                        ...
                        <form name="Form1" method="post" action="EducationServlet?id=cee5ad2d4e49b1d23bfa995de0f2&amp;ran=nq6fxcdiboiu">
                            ...
                            <p><input type="hidden" name="qualKey" value="1I"></p>
                            ...
                            <div class="thisFormElem"><!--open form element -->
                                ...
                                <div class="thisFormField">
                                    <div id="fitWidth"><select name="cboModTitle0" size="1" onchange="document.forms[0].modTitleTextEntry0.value='';" class="floatLeft" id="modTitleCombo0">
                                            <option value="">Please select...</option>
                                            <option value="Biological systems and disease">Biological systems and disease</option>
                                            <option value="The diversity of living organisms">The diversity of living organisms</option>
                                        </select>
                                    </div>
