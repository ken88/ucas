            ...
            <div id="gatewayContent">
                ...
                <div id="midBoxInternalWide">
                    ...
                    <div class="thisForm">
                        ...
                        <p>Before starting your application, please read through the relevant information below regarding: </p><ul class="display"><li>
                                <a class="plain">completing your application</a></li><li>
                                <a class="plain">applicants applying through a school, college or organisation</a></li><li>
                                <a  class="plain">applicants applying as an individual</a></li><li>
                                <a class="plain">deadlines for submitting your application.</a></li></ul><p></p>
