                        ...
                        <form name="Form1" method="post" action="">
                                ...
                                <div class="thisFormField">
                                    <div id="fitWidth">
                                        <select name="cboTitle" size="1" class="floatLeft" id="titleCombo">
                                            ...
                                            ?>
                                            <option <?php if($title==\common\logics\Func::getAttributes($data, 'cboTitle') )echo 'selected' ?> value="<?= $title ?>"><?= $title ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="thisFormField">
                                    <div id="fullWidth">
                                        <select name="cboQualMonth" size="1" class="floatLeft" id="qualDateCombo">
                                            ...
                                            ?>
                                            <option <?php if($k==\common\logics\Func::getAttributes($data,'cboQualMonth')) echo 'selected'?> value="<?= $k ?>"><?= $v ?></option>
                                            <?php } ?>
                                        </select>
                                        <select name="cboQualYear" size="1" class="floatLeft" id="qualDateCombo">
                                            <option value="">Year</option>
                                            <?php foreach (\common\logics\Func::generateYear() as $v){ ?>
                                            <option <?php if (\common\logics\Func::getAttributes($data, 'cboQualYear')==$v ) echo 'selected' ?> value="<?= $v ?>"><?= $v ?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                            ...
                            <div class="thisFormElem"><!--open form element -->
                                ...
                                <div class="thisFormField">
                                    <div id="fullWidth"><select name="cboGrade" size="1" onchange="document.forms[0].gradeTextEntry.value='';" class="floatLeft" id="gradeCombo">
                                            ...
                                            <option value="A*" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='A*') echo 'selected' ?>>A*</option>
                                            <option value="A" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='A') echo 'selected' ?>>A</option>
                                            <option value="B" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='B') echo 'selected' ?>>B</option>
                                            <option value="C" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='C') echo 'selected' ?>>C</option>
                                            <option value="D" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='D') echo 'selected' ?>>D</option>
                                            <option value="E" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='E') echo 'selected' ?>>E</option>
                                            <option value="U (Ungraded)" <?php if(\common\logics\Func::getAttributes($data, 'cboGrade')=='U') echo 'selected' ?>>U (Ungraded)</option>
                                        </select>
                                    </div>
                            ...
                            <?php }else{
                                ...
                                <?php foreach ($cboModYears as $key=>$cboModYear){?>
                                    <div id="unit" class="unit">
                                        <hr>
                                        <h2 class="inPage">Module / unit <span class="num"><?= ($key+1)?></span><span class="Req">*</span></h2>
                                        <!--Module Title-->
                                        <div class="thisFormElem"><!--open form element -->
                                            <div class="thisFormTxt">
                                                <label for="module title">Subject<span class="Req">*</span></label>
                                            ...
                                            <div class="thisFormField">
                                                <div id="fitWidth">
                                                    <select name="cboModTitle0[]" size="1"  class="floatLeft sub-x" id="modTitleCombo0">
                                                        ...
                                                        foreach ($t_arr as $ar){?>
                                                        <option <?php if ($cboModTitles[$key]==$ar) echo 'selected' ?> value="<?= $ar?>"><?= $ar?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <a href="#" onclick="launchFieldHelp('PopUpServlet', '?functionname=help&amp;page=HELP.EDUCATION.QUALIFICATION.FIELD.MODTITLE'); return false;"><img src="/static/images/questMarkBox.gif" width="20" height="20" class="floatLeft" alt="Help"></a>
                                                <div class="clearDiv">&nbsp;</div>(other)
                                                <input type="text" name="txtModTitle0[]" value="<?= $txtModTitles[$key]?>" size="39" maxlength="50" onchange="if(document.forms[0].modTitleCombo0){document.forms[0].modTitleCombo0.selectedIndex=0;}" class="floatLeft" id="modTitleTextEntry0">
                                            </div>
                                        </div><!--close form element -->
                                        <!--Module Start date-->
                                        <div class="thisFormElem">
                                            ...
                                            <div class="thisFormField">
                                                <div id="fullWidth"><select name="cboModMonth0[]" size="1" class="floatLeft" id="modDateCombo0">
                                                        <option value="-">Month</option>
                                                        <?php foreach (Yii::$app->params['months'] as $k=>$month){ ?>
                                                            <option <?php if ($cboModMonths[$key]==$k) echo 'selected'?> value="<?= $k ?>"><?= $month?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <select name="cboModYear0[]" size="1" class="floatLeft" id="modDateCombo0">
                                                        <option value="">Year</option>
                                                        <?php foreach (\common\logics\Func::generateYear() as $year){ ?>
                                                            <option <?php if ($cboModYears[$key]==$year) echo 'selected'?> value="<?= $year ?>"><?= $year ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <a href="#" onclick="launchFieldHelp('PopUpServlet', '?functionname=help&amp;page=HELP.EDUCATION.QUALIFICATION.FIELD.MODDATE'); return false;"><img src="/static/images/questMarkBox.gif" width="20" height="20" class="floatLeft" alt="Help"></a>
                                        ...
                                        <div class="thisFormElem"><!--open form element -->
                                            ...
                                            <div class="thisFormField">
                                                <input type="text" name="txtModGrade0[]" value="<?= $txtModGrades[$key]?>" size="14" maxlength="15" onchange="if(document.forms[0].modGradeCombo0){document.forms[0].modGradeCombo0.selectedIndex=0;}" class="floatLeft" id="modGradeTextEntry0">
                                                <a href="#" onclick="launchFieldHelp('PopUpServlet', '?functionname=help&amp;page=HELP.EDUCATION.QUALIFICATION.FIELD.MODGRADE'); return false;"><img src="/static/images/questMarkBox.gif" width="20" height="20" class="floatLeft" alt="Help"></a>
                                            </div>
                                        </div><!--close form element -->
                                        <div class="clearDiv">&nbsp;</div>
